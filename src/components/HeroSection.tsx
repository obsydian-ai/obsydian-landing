...
const HeroSection = () => {
  ...
  // Efecto para rotar las palabras cada 2 segundos
  useEffect(() => {
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="w-full bg-neutral-600/30 rounded-full h-1">
                  <div className="bg-primary-400 h-1 rounded-full" style={{ width: '95%' }}></div>
                </div>
                ...
                <div className="w-full bg-neutral-600/30 rounded-full h-1">
                  <div className="bg-emerald-400 h-1 rounded-full" style={{ width: '92%' }}></div>
                </div>
